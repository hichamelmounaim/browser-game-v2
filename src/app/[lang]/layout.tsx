      ...
      <body className="bg-background text-on-surface font-body-md min-h-screen">
        ...
        <Script id="yandex-metrika" strategy="afterInteractive">
          {`
            ...
            })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=109996366', 'ym');

            ym(109996366, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
          `}
        </Script>
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/109996366" style={{ position: 'absolute', left: '-9999px' }} alt="" />
          </div>
        </noscript>
        {children}
      </body>
